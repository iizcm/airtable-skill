...
cp -r productivity/airtable ~/.hermes/skills/productivity/airtable/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/airtable-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/airtable-skill.git ~/.hermes/skills/productivity/airtable/
```
...
```text
skill_view(name="productivity/airtable")
```
...
```text
Use the airtable skill to <describe your specific task here>
```
...
```text
Gunakan skill airtable untuk <deskripsikan tugas spesifik Anda di sini>
```
